import 'dart:async';
import 'dart:convert';
import 'package:apiflutterlogin/view/detalle_Producto.dart';
...
class _ListarProductosState extends State<ListarProductos> {
  ...
  Future<List> getProducto() async {
    ...
    final response = await http.get("http://192.168.0.11:8000/api/products");
      ...
      itemBuilder: (context, i) {
        return new Container(
            ...
            child: new GestureDetector(
              //cuando presiones nos mande al dialog para eliminar o editar
